public class Gym{
	...
	Gym(String name,String gender,int age,String joiningDate,int fees,int weight,String packageFees){
		this.name = name;
		this.gender = gender;
		this.age = age;
	...
	public static void main(String [] args){
		...
		Gym fn = new Gym("Darshan","Male",25,"1/9/2023",1500,68,"Monthly");
	    Gym fn1 = new Gym("Arun","Male",29,"1/8/2023",1500,68,"3 Months");
	    Gym fn2 = new Gym("Vignesh","Male",23,"11/9/2023",1500,68,"Year");

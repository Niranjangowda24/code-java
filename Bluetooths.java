public class Bluetooths{
	...
	Bluetooths(String color,int button,int price,boolean anc,String modelNo,String batteryBackup,float ratings){
		this.color = color;
		this.button = button;
		this.price = price;
		this.anc = anc;
	...
	public static void main(String [] args){
		...
		Bluetooths ap = new Bluetooths("Black",1,3999,true,"a-181","24hrs",4.5f);
		Bluetooths ap1 = new Bluetooths("White",1,2999,true,"a-121","24hrs",3.5f);
		Bluetooths ap2 = new Bluetooths("Red",1,4999,true,"a-281","24hrs",4.5f);

public class Mobile{
	...
	Mobile(String customerName,int ramInGB,int memoryInGB,float displaySize,int amount,float ratings,int manufYear){
	...
	public static void main(String [] args){
		...
		Mobile cp = new Mobile("Varun",8,128,6.1f,25000,4.5f,2020);
		Mobile cp1 = new Mobile("Harsha",12,128,6.0f,24000,4.0f,2019);
		Mobile cp2 = new Mobile("Amit",6,60,5.7f,18000,3.5f,2021);

public class Usedcar {
	...
	Usedcar(String carName,String ownerName,int presentPrice,int sellingPrice,int kmsDriven,String transmission,int weight){
	...
	public static void main(String[] args){
		...
		Usedcar ct =new Usedcar("Verna","Ram",235000,200000,35000,"Manual",3504);
		Usedcar ct1 =new Usedcar("Creta","Shekar",250000,200000,30000,"Manual",4504);
		Usedcar ct2 =new Usedcar("Venue","Prasad",150000,120000,20000,"Manual",2504);
